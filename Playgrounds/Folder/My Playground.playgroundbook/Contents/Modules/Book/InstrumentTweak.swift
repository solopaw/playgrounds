...
/// Types of tweak that can be applied to an instrument.
///
...
/// Effects to tweak how the instrument sounds.
///
...
struct InstrumentTweak {
    ...
    ///
    /// - Parameter type: The type of the instrument tweak.
    /// - Parameter effectFrom: The start value of the tweak effect.
    /// - Parameter to: The end value of the tweak effect.
    ///
