...
public struct SpeechTweak {
    ...
    /// Create an speech tweak whose effect varies by the values (from 0 to 100). Depending on where you touch the keyboard, it will apply a different value within the range.
    ///
